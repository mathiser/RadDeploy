...
class MQSub(MQBase):
    ...
    def consume(self):
        ...
        # Declare queue
        queue = self.setup_queue(exchange=self.exchange,
    ...
    def on_message(self, _unused_channel, basic_deliver, properties, body):
        ...
        t = threading.Thread(target=self.work_function_wrapper, args=(self._connection, self._channel, basic_deliver, properties, body))
        t.start()
